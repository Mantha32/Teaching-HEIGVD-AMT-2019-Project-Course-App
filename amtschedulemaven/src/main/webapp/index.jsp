				...
				<div id="content-wrapper">
					...
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-xl-3 col-sm-6 mb-3">
								<div class="card text-white bg-success o-hidden h-100 niveau">
									<div class="card-body">
										<div class="card-body-icon">
											<i class="fas fa-fw fa-list"></i>
										</div>
										<div class="mr-5">Niveau</div>
									</div>
									<span id="btnNiveau"
										class="card-footer text-white clearfix small z-1"> <span
										class="float-left"> consulter </span> <span
...
<script type="text/javascript">
	$(function() {
		...
		populate_owner('tableEnseignant.jsp');

		$('#btnEnseignant').on('click', function() {
			populate_owner('tableEnseignant.jsp');
		});
		$('#btnSalle').on('click', function() {
			populate_owner('tableSalleP.jsp');
		});
		$('#btnNiveau').on('click', function() {
			populate_owner('tableNiveau.jsp');
		});
	});
</script>
