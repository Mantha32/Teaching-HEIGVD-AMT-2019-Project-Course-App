    ...
    <div class="col-md-12">
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item active"><a class="nav-link" href="classroom">
                ...
                <div class="table-responsive" style="margin-left: 30px; margin-right: 50px">
                    <table class="table table-hover table-dark"
                        ...
                        <tr class="note">
                            ...
                            <td class="code text-center"><%= classroom.getName() %></td>
                            <td class="text-center"><%= classroom.getFloor() %></td>
                        </tr>
                        <%
                            }
                        %>
...
<script>
    $(function() {
        ...
        function populate_calendar(tab) {
            ...
            $.ajax({
                url : 'cours?criteria=classroom&key=' + tab[1],
                dataType : 'xml',
                type : 'GET',
