<%-- 
    Document   : charts
    Created on : 18 juil. 2019, 16:15:12
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Acceuil</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="eventModif.html">
      ...
      <li class="nav-item">
          <a class="nav-link" href="blank - Salle.html">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
              <div class="form-row">
                  <div class="col-md-3 float-left"  style="border: 1px solid black;">
                         
                                <!-- Les listes des differents enseignants-->
                               <div id="enseignant" class="col">
                                    <h4 class="text-center"> Enseignants</h4><hr>
...
<div class="container col-md-9">
      ...
      <!-- Sticky Footer -->
      <footer class="sticky-footer" style="position: relative; width: 100%;">
