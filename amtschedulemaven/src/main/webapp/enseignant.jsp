		...
		<div class="col-md-12">
			...
			<div id="wrapper">
				...
				<ul class="sidebar navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="courses?criteria=user&userid=${sessionScope.userid}">
							<i class="fas fa-fw fa-users"></i> <span>Mes Cours</span>
					</a></li>
